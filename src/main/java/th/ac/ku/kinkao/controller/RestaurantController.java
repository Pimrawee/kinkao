...
public class RestaurantController {
    ...
    @PostMapping("/add")
    public String addRestaurant(@ModelAttribute Restaurant restaurant, Model model) { // @ModelAttribute จะรับค่ามาจาก form แล้วจะห่อหุ้มเป็น restaurant (object) ส่งไปให้เรา
